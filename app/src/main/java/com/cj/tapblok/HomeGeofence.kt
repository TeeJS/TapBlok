 ...
 * moments — when the block screen appears and when a tag is scanned — and TapBlok is in the
...
object HomeGeofence {
     ...
     * fresh fix with a short timeout. TapBlok is on screen at this point, so a brief wait is
