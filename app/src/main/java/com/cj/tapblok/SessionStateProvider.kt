...
/**
 * Lets companion apps ask "is a TapBlok session active right now?" — built for
 * scroll-blocker, which enforces its Shorts/Reels blocking only while TapBlok is enforcing
 ...
 * with the same key as TapBlok can hold it, so this surface is invisible to everything else
